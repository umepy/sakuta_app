  ...
  render(){
    return (
      ...
      /* <a href="" onClick={e => openNewTab(e,this.props.url)} > クリックしたら編集したり窓空いたりする仕掛け欲しいTODO */
        ...
        React.createElement("span", {class: "titel"}, this.state.title, React.createElement("br", null)), 
        React.createElement("span", {class: "description"}, this.state.description, React.createElement("br", null)), 
