  ...
  componentWillMount(){
    ...
    .then(responseText => {
      this.setState({ 
        ...
        url: this.props.url,
        favicon: $(responseText).filter("meta[property='og:favicon']").attr('content') 
      });
    });
  }
    ...
    return (
      React.createElement("div", {class: "webinfo-component", style: {width: '500px'}}, 
        ...
        React.createElement("div", {class: "frontground"}, 
          ...
          React.createElement("span", {class: "url"}, React.createElement("a", {href: "#"}, React.createElement("span", {class: "url-brand", style: {backgroundImage: "url(" + this.state.favicon + ")"}}), this.state.url))
          )
        )
    )
  }
